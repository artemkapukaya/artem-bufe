...
// DB'den ürünleri çek - localStorage yok
                    ...
                    >
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`flex flex-col items-center gap-1 p-2 rounded-xl border-2 transition-all duration-200 shrink-0 w-28 ${activeCategory === cat.id
                            ...
                            >
                                ...
                                <span
                                    className={`text-xs font-bold text-center leading-tight ${activeCategory === cat.id ? "text-orange-600" : "text-gray-700"
                                        }`}
                                >
                                    {cat.name}
                                </span>
